...
<body>
	<form action="../index.jsp" method="get">
		<h1 class="member">Professor List</h1>
		<div class="form">
			<table border="1" cellspacing="0" cellpadding="0">
				...
				<%
					...
					String sql = "select * from professorjw";
					...
					while (rs.next()) {
						...
						out.print("<tr><td>" + no + "</td>" + "<td>" + irum + "</td>" + "<td>" + age + "</td>" + "<td>"
								+ subject + "</td></tr>");
					}
					stmt.close();
					conn.close();
	...
	<br>
	<div id="link">
	<a href="professor_register_form.jsp">교수등록</a>
	<br>
