...
<body>
	<form action="../index.jsp" method="get">
		<h1 class="member">Manager List</h1>
		<div class="form">
			<table border="1" cellspacing="0" cellpadding="0">
				...
				<%
					...
					String sql = "select * from managerjw";
					...
					while (rs.next()) {
						...
						out.print("<tr><td>" + no + "</td>" + "<td>" + irum + "</td>" + "<td>" + age + "</td>" + "<td>" + part
								+ "</td></tr>");
					}
					stmt.close();
					conn.close();
	...
	<br>
	<div id="link">
		<a href="manager_register_form.jsp">매니저등록</a> <br> <a
